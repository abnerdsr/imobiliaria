    ...
    <div class="dropdown w-75">
        <a href="#" class="nav-link p-0 d-flex align-items-center" data-bs-toggle="dropdown">
            ...
            <span class="d-block small">
                <span class="text-ellipsis text-white"
                    style="max-width: 12em;">{{ Auth::user()->presenter()->title() }}</span>
        ...
        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow bg-white">
            ...
            <a href="{{ route('platform.logout') }}" class="dropdown-item" data-controller="form"
